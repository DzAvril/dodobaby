...
一个适合家庭共同使用的宝宝照护记录网站。首页只提供跨模块概览，辅食、喂养、睡眠、尿布、生长、疫苗与设置均使用独立页面；当前支持辅食月历、多餐与反应记录，亲喂与瓶喂时间线，跨午夜睡眠，尿布观察，体重、身高、头围趋势，以及家庭接种计划与实际接种事实记录。
...
CI 还会启动实际 Docker 容器，在隔离数据库中验证登录保护、同源拦截、睡眠、尿布、喂养与疫苗记录 CRUD、真实 PDF 导出，以及桌面和手机端的关键浏览器交互。
